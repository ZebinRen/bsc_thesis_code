...
class GraphSageMaxPool(BaseModel):
    def __init__(self,
         ...
         transform_size,
         max_degree):
        super(GraphSageMaxPool, self).__init__(
            hidden_num, hidden_dim,
            input_dim, output_dim,
            learning_rate, epochs,
            weight_decay, early_stopping,
        ...
        self.placeholders['neigh_info'] = tf.placeholder(tf.int32, shape = (self.total_nodes, self.max_degree), name='neigh_info')
        ...
        self.neigh_info = self.placeholders['neigh_info']
    ...
    def train(self, sess, adj, features, train_label, val_label, train_mask, val_mask, num_features_nonzero, degrees, neigh_info):
        '''
        Train the model
        '''
    ...
    def predict(self, sess, adj, features, label, mask, num_features_nonzero, degrees, neigh_info):
        '''
    ...
    def test(self, sess, adj, features, label, mask, num_features_nonzero, degrees, neigh_info):
        '''
